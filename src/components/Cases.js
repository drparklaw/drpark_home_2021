...
const recent_cases = [
    ...
    }, 
    {
        ...
        content: '책임보험 한도액이 다수 피해자의 손해 합계액에 미치지 못하여 피해자의 직접청구권과 화재보험사가 보험금을 지급한 후 보험자대위로 취득한 직접청구권이 경합하는 경우 원칙적으로 피해자의 직접청구권이 우선한다. 또한 가해자의 책임보험자가 다른 피해자의 화재보험자이기도 하여 직접청구권을 보험자대위로 취득하였다면 책임보험자의 손해배상채무가 혼동에 의하여 소멸한다.'
    }
