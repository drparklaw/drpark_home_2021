...
const drpark_papers = [
    ...
    },
    {
        id: 20,
        name: '두샤오얀·박봉철·왕명립',
        title: '"중국 이혼냉정기와 재판상 이혼의 절차적 조정 - 한국 가사상담제도의 경험과 시사점을 중심으로 -"',
        journal: '법학연구 제37권 제1호',
        institute: '충남대학교 법학연구소',
        year: '2026.2',
        page: 'pp.295-320',
        pic: ''
    },                                    
    {
        id: 21,
        name: '두샤오얀·박봉철·왕명립',
        title: '"‘행정적 저지’에서 ‘사법적 분류’로 - 이혼 냉정기 개혁의 중국 경로와 한국의 거울로서의 시사점 -"',
        journal: '외법논집 제50권 제1호',
        institute: '한국외국어대학교 법학연구소',
        year: '2026.2',
        page: 'pp.225-246',
        pic: ''
    },                                 
    {
        id: 22,
        name: '두샤오얀·박봉철·왕명립',
        title: '"치료적 사법 관점에서 본 중국 이혼냉정기 제도의 최적화 경로 - 중·한 비교를 중심으로 -"',
        journal: '비교사법 제33권 제2호',
        institute: '한국사법학회',
        year: '2026.5',
        page: 'pp.101-114',
        pic: ''
    },
    {
        id: 23,
        name: '두샤오얀·박봉철·왕명립',
        title: '"중국 이혼 냉각기 제도의 재구성 — 치료적 사법 이론에 기초한 한국 이혼 숙려기 제도 비교분석 —"',
        journal: '서울법학 제34권 제1호',
        institute: '서울시립대학교 법학연구소',
        year: '2026.5',
        page: 'pp.37-68',
        pic: ''
    },                                   
